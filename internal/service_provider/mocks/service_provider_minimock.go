...
//go:generate minimock -i github.com/justbrownbear/microservices_course_auth/internal/service_provider.ServiceProvider -o service_provider_minimock.go -n ServiceProviderMock -p service_provider_mock
...
// ServiceProviderMock implements mm_service_provider.ServiceProvider
type ServiceProviderMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcGetUserService          func() (u1 user_service.UserService)
	funcGetUserServiceOrigin    string
...
// NewServiceProviderMock returns a mock for mm_service_provider.ServiceProvider
...
func (mmGetUserService *mServiceProviderMockGetUserService) Return(u1 user_service.UserService) *ServiceProviderMock {
	...
	mmGetUserService.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetUserService *mServiceProviderMockGetUserService) Set(f func() (u1 user_service.UserService)) *ServiceProviderMock {
	...
	mmGetUserService.mock.funcGetUserServiceOrigin = minimock.CallerInfo(1)
	return mmGetUserService.mock
}
...
func (mmGetUserService *mServiceProviderMockGetUserService) Times(n uint64) *mServiceProviderMockGetUserService {
	...
	mmGetUserService.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetUserService
}
...
// GetUserService implements mm_service_provider.ServiceProvider
...
func (m *ServiceProviderMock) MinimockGetUserServiceInspect() {
	...
	if m.GetUserServiceMock.defaultExpectation != nil && afterGetUserServiceCounter < 1 {
		m.t.Errorf("Expected call to ServiceProviderMock.GetUserService at\n%s", m.GetUserServiceMock.defaultExpectation.returnOrigin)
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetUserService != nil && afterGetUserServiceCounter < 1 {
		m.t.Errorf("Expected call to ServiceProviderMock.GetUserService at\n%s", m.funcGetUserServiceOrigin)
	}

	if !m.GetUserServiceMock.invocationsDone() && afterGetUserServiceCounter > 0 {
		m.t.Errorf("Expected %d calls to ServiceProviderMock.GetUserService at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetUserServiceMock.expectedInvocations), m.GetUserServiceMock.expectedInvocationsOrigin, afterGetUserServiceCounter)
	}
}
