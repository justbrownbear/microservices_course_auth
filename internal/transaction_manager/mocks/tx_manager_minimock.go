...
//go:generate minimock -i github.com/justbrownbear/microservices_course_auth/internal/transaction_manager.TxManager -o tx_manager_minimock.go -n TxManagerMock -p transaction_manager_mock
...
import (
	...
	mm_transaction_manager "github.com/justbrownbear/microservices_course_auth/internal/transaction_manager"
)
