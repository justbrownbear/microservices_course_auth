...
//go:generate minimock -i github.com/justbrownbear/microservices_course_auth/internal/service/user.UserService -o user_service_minimock.go -n UserServiceMock -p user_service_mock
...
// UserServiceMock implements mm_user_service.UserService
type UserServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreateUser          func(ctx context.Context, userData *user_model.CreateUserRequest) (u1 uint64, err error)
	funcCreateUserOrigin    string
	inspectFuncCreateUser   func(ctx context.Context, userData *user_model.CreateUserRequest)
	...
	funcGetUser          func(ctx context.Context, userID uint64) (gp1 *user_model.GetUserResponse, err error)
	funcGetUserOrigin    string
	inspectFuncGetUser   func(ctx context.Context, userID uint64)
	afterGetUserCounter  uint64
	beforeGetUserCounter uint64
	GetUserMock          mUserServiceMockGetUser

	funcUpdateUser          func(ctx context.Context, userData *user_model.UpdateUserRequest) (err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, userData *user_model.UpdateUserRequest)
	afterUpdateUserCounter  uint64
	beforeUpdateUserCounter uint64
	UpdateUserMock          mUserServiceMockUpdateUser
}

// NewUserServiceMock returns a mock for mm_user_service.UserService
...
func (mmCreateUser *mUserServiceMockCreateUser) Expect(ctx context.Context, userData *user_model.CreateUserRequest) *mUserServiceMockCreateUser {
	...
	mmCreateUser.defaultExpectation.params = &UserServiceMockCreateUserParams{ctx, userData}
...
// ExpectUserDataParam2 sets up expected param userData for UserService.CreateUser
func (mmCreateUser *mUserServiceMockCreateUser) ExpectUserDataParam2(userData *user_model.CreateUserRequest) *mUserServiceMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
	...
	mmCreateUser.defaultExpectation.paramPtrs.userData = &userData
	mmCreateUser.defaultExpectation.expectationOrigins.originUserData = minimock.CallerInfo(1)

	return mmCreateUser
}

// Inspect accepts an inspector function that has same arguments as the UserService.CreateUser
func (mmCreateUser *mUserServiceMockCreateUser) Inspect(f func(ctx context.Context, userData *user_model.CreateUserRequest)) *mUserServiceMockCreateUser {
...
func (mmCreateUser *mUserServiceMockCreateUser) Return(u1 uint64, err error) *UserServiceMock {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
	...
	mmCreateUser.defaultExpectation.results = &UserServiceMockCreateUserResults{u1, err}
...
func (mmCreateUser *mUserServiceMockCreateUser) Set(f func(ctx context.Context, userData *user_model.CreateUserRequest) (u1 uint64, err error)) *UserServiceMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserServiceMockCreateUser) When(ctx context.Context, userData *user_model.CreateUserRequest) *UserServiceMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserServiceMock.CreateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateUserExpectation{
		...
		params:             &UserServiceMockCreateUserParams{ctx, userData},
...
func (e *UserServiceMockCreateUserExpectation) Then(u1 uint64, err error) *UserServiceMock {
	e.results = &UserServiceMockCreateUserResults{u1, err}
	return e.mock
}
...
// CreateUser implements mm_user_service.UserService
func (mmCreateUser *UserServiceMock) CreateUser(ctx context.Context, userData *user_model.CreateUserRequest) (u1 uint64, err error) {
	...
	if mmCreateUser.inspectFuncCreateUser != nil {
		mmCreateUser.inspectFuncCreateUser(ctx, userData)
	}

	mm_params := UserServiceMockCreateUserParams{ctx, userData}
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateUserParams{ctx, userData}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userData != nil && !minimock.Equal(*mm_want_ptrs.userData, mm_got.userData) {
				mmCreateUser.t.Errorf("UserServiceMock.CreateUser got unexpected parameter userData, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateUser.CreateUserMock.defaultExpectation.expectationOrigins.originUserData, *mm_want_ptrs.userData, mm_got.userData, minimock.Diff(*mm_want_ptrs.userData, mm_got.userData))
			}
	...
	if mmCreateUser.funcCreateUser != nil {
		return mmCreateUser.funcCreateUser(ctx, userData)
	}
	mmCreateUser.t.Fatalf("Unexpected call to UserServiceMock.CreateUser. %v %v", ctx, userData)
	return
}
...
func (mmDeleteUser *mUserServiceMockDeleteUser) Expect(ctx context.Context, userID uint64) *mUserServiceMockDeleteUser {
...
func (mmDeleteUser *mUserServiceMockDeleteUser) ExpectUserIDParam2(userID uint64) *mUserServiceMockDeleteUser {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserServiceMock.DeleteUser mock is already set by Set")
	}
...
func (mmDeleteUser *mUserServiceMockDeleteUser) Inspect(f func(ctx context.Context, userID uint64)) *mUserServiceMockDeleteUser {
...
func (mmDeleteUser *mUserServiceMockDeleteUser) Set(f func(ctx context.Context, userID uint64) (err error)) *UserServiceMock {
	if mmDeleteUser.defaultExpectation != nil {
...
// Then helper
func (mmDeleteUser *mUserServiceMockDeleteUser) When(ctx context.Context, userID uint64) *UserServiceMockDeleteUserExpectation {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserServiceMock.DeleteUser mock is already set by Set")
	}
...
// DeleteUser implements mm_user_service.UserService
func (mmDeleteUser *UserServiceMock) DeleteUser(ctx context.Context, userID uint64) (err error) {
...
type UserServiceMockGetUserResults struct {
	gp1 *user_model.GetUserResponse
	err error
}
...
func (mmGetUser *mUserServiceMockGetUser) Expect(ctx context.Context, userID uint64) *mUserServiceMockGetUser {
...
func (mmGetUser *mUserServiceMockGetUser) ExpectUserIDParam2(userID uint64) *mUserServiceMockGetUser {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserServiceMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mUserServiceMockGetUser) Inspect(f func(ctx context.Context, userID uint64)) *mUserServiceMockGetUser {
...
func (mmGetUser *mUserServiceMockGetUser) Return(gp1 *user_model.GetUserResponse, err error) *UserServiceMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserServiceMock.GetUser mock is already set by Set")
	}
	...
	mmGetUser.defaultExpectation.results = &UserServiceMockGetUserResults{gp1, err}
...
func (mmGetUser *mUserServiceMockGetUser) Set(f func(ctx context.Context, userID uint64) (gp1 *user_model.GetUserResponse, err error)) *UserServiceMock {
	if mmGetUser.defaultExpectation != nil {
...
// Then helper
func (mmGetUser *mUserServiceMockGetUser) When(ctx context.Context, userID uint64) *UserServiceMockGetUserExpectation {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserServiceMock.GetUser mock is already set by Set")
	}
...
func (e *UserServiceMockGetUserExpectation) Then(gp1 *user_model.GetUserResponse, err error) *UserServiceMock {
	e.results = &UserServiceMockGetUserResults{gp1, err}
	return e.mock
}
...
// GetUser implements mm_user_service.UserService
func (mmGetUser *UserServiceMock) GetUser(ctx context.Context, userID uint64) (gp1 *user_model.GetUserResponse, err error) {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Expect(ctx context.Context, userData *user_model.UpdateUserRequest) *mUserServiceMockUpdateUser {
	...
	mmUpdateUser.defaultExpectation.params = &UserServiceMockUpdateUserParams{ctx, userData}
...
// ExpectUserDataParam2 sets up expected param userData for UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) ExpectUserDataParam2(userData *user_model.UpdateUserRequest) *mUserServiceMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
	...
	mmUpdateUser.defaultExpectation.paramPtrs.userData = &userData
	mmUpdateUser.defaultExpectation.expectationOrigins.originUserData = minimock.CallerInfo(1)

	return mmUpdateUser
}

// Inspect accepts an inspector function that has same arguments as the UserService.UpdateUser
func (mmUpdateUser *mUserServiceMockUpdateUser) Inspect(f func(ctx context.Context, userData *user_model.UpdateUserRequest)) *mUserServiceMockUpdateUser {
...
func (mmUpdateUser *mUserServiceMockUpdateUser) Set(f func(ctx context.Context, userData *user_model.UpdateUserRequest) (err error)) *UserServiceMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserServiceMockUpdateUser) When(ctx context.Context, userData *user_model.UpdateUserRequest) *UserServiceMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserServiceMock.UpdateUser mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateUserExpectation{
		...
		params:             &UserServiceMockUpdateUserParams{ctx, userData},
...
// UpdateUser implements mm_user_service.UserService
func (mmUpdateUser *UserServiceMock) UpdateUser(ctx context.Context, userData *user_model.UpdateUserRequest) (err error) {
	...
	if mmUpdateUser.inspectFuncUpdateUser != nil {
		mmUpdateUser.inspectFuncUpdateUser(ctx, userData)
	}

	mm_params := UserServiceMockUpdateUserParams{ctx, userData}
	...
	if mmUpdateUser.UpdateUserMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateUserParams{ctx, userData}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userData != nil && !minimock.Equal(*mm_want_ptrs.userData, mm_got.userData) {
				mmUpdateUser.t.Errorf("UserServiceMock.UpdateUser got unexpected parameter userData, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUpdateUser.UpdateUserMock.defaultExpectation.expectationOrigins.originUserData, *mm_want_ptrs.userData, mm_got.userData, minimock.Diff(*mm_want_ptrs.userData, mm_got.userData))
			}
	...
	if mmUpdateUser.funcUpdateUser != nil {
		return mmUpdateUser.funcUpdateUser(ctx, userData)
	}
	mmUpdateUser.t.Fatalf("Unexpected call to UserServiceMock.UpdateUser. %v %v", ctx, userData)
	return
}
